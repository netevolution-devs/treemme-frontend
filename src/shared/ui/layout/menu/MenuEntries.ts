...
export const MenuEntries: IMenuEntry[] = [
        ...
        subMenu: [
            {
                ...
                component: "leathers",
                permissionCheck: {resource: "pellami - pellami", action: "get"}
            },
            {
                i18nKey: "menu.leathers.weights",
                component: "weights",
                permissionCheck: {resource: "pellami - pesi", action: "get"}
            },
            {
                i18nKey: "menu.leathers.species",
                component: "species",
                permissionCheck: {resource: "pellami - specie", action: "get"}
            },
            // {i18nKey: "menu.leathers.sizes", component: "sizes" },
            {
                i18nKey: "menu.leathers.thicknesses",
                component: "thicknesses",
                permissionCheck: {resource: "pellami - spessori", action: "get"}
            },
            {
                i18nKey: "menu.leathers.types",
                component: "types",
                permissionCheck: {resource: "pellami - tipologie", action: "get"}
            },
            {
                i18nKey: "menu.leathers.flaying",
                component: "flaying",
                permissionCheck: {resource: "pellami - scuoiature", action: "get"}
            },
            {
                i18nKey: "menu.leathers.origins",
                component: "origins",
                permissionCheck: {resource: "pellami - provenienze", action: "get"}
            },
            {
                i18nKey: "menu.leathers.tanning-stages",
                component: "tanningStages",
                permissionCheck: {resource: "pellami - stati di lavorazione", action: "get"}
            },
        ]
    },
    {
        ...
        subMenu: [
            // {i18nKey: "menu.products.products", component: "products", permissionCheck: {resource: "prodotti - prodotti", action: "get"}},
            {
                ...
                component: "articles",
                permissionCheck: {resource: "articoli - articoli", action: "get"}
            },
            {
                i18nKey: "menu.products.selection",
                component: "selection",
                permissionCheck: {resource: "articoli - scelte", action: "get"}
            },
            ...
            // {i18nKey: "menu.products.products-types", component: "productTypes", permissionCheck: {resource: "prodotti - tipologie prodotti", action: "get"}},
            {
                ...
                permissionCheck: {resource: "articoli - tipologie articoli", action: "get"}
            },
            {
        ...
        subMenu: [
            {
                ...
                permissionCheck: {resource: "ordini - ordini clienti", action: "get"}
            },
    ...
    },
    {
        ...
        subMenu: [
            {
                i18nKey: "menu.production.batches",
                component: "batches",
                permissionCheck: {resource: "produzione - lotti", action: "get"}
            },
            // {i18nKey: "menu.production.recipes"},
            {
                i18nKey: "menu.production.machinery",
                component: "machinery",
                permissionCheck: {resource: "produzione - macchinari", action: "get"}
            },
            // {i18nKey: "menu.production.progress"},
            {
                i18nKey: "menu.production.processes",
                component: "processes",
                permissionCheck: {resource: "produzione - produzione", action: "get"}
            },
            {
                i18nKey: "menu.production.workings",
                component: "workings",
                permissionCheck: {resource: "produzione - lavorazioni", action: "get"}
            },
        ...
        subMenu: [
            {
                ...
                permissionCheck: {resource: "ddt & fatture - documenti di trasporto", action: "get"}
            },
            {
                i18nKey: "menu.shipping-invoicing.reasons",
                component: "reasons",
                permissionCheck: {resource: "ddt & fatture - ragioni di trasporto", action: "get"}
            },
            // {i18nKey: "menu.shipping-invoicing.invoices"},
            // {i18nKey: "menu.shipping-invoicing.search"},
            {
                i18nKey: "menu.shipping-invoicing.subcontracting-not-returned",
                component: "subcontractingNotReturned",
                permissionCheck: {resource: "ddt & fatture - lotti conto lavoro", action: "get"}
            },
        ]
    },
    {
        ...
        subMenu: [
            ...
            // {i18nKey: "menu.commercial.work-reports"},
            {
                ...
                component: "currenciesExchange",
                permissionCheck: {resource: "commerciale - valute e cambi", action: "get"}
            },
            {
                i18nKey: "menu.commercial.payment-types",
                component: "paymentTypes",
                permissionCheck: {resource: "commerciale - tipi pagamento", action: "get"}
            },
            {
                i18nKey: "menu.commercial.shipment-conditions",
                component: "shipmentConditions",
                permissionCheck: {resource: "commerciale - condizioni resa", action: "get"}
            }
        ]
    },
    {
    ...
    },
    {
        ...
        subMenu: [
            ...
            {
                i18nKey: "menu.system.organization",
                component: "organization-management",
                permissionCheck: {resource: "sistema - permessi", action: "get"}
            },
            {
                i18nKey: "menu.system.functionality",
                component: "functionality-management",
                permissionCheck: {resource: "sistema - permessi", action: "get"}
            },
