import { Box, Card, CardContent, Chip, Divider, Grid, Stack, Typography, Button } from "@mui/material";
import {
    Email as EmailIcon,
    Phone as PhoneIcon,
    Home as HomeIcon,
...
const UserProfileCard: React.FC<UserProfileCardProps> = ({ userCode }) => {
                ...
                <Stack spacing={2}>
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid size={12}>
                            ...
                            <RowDisplay icon={CalendarIcon} text={dayjs(user?.createdAt).format("DD MMMM YYYY [alle] HH:mm")} />
                        </Grid>
                    </Grid>
                </Stack>
            </CardContent>
